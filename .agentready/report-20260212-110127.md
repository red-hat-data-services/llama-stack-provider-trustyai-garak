...
**Path**: `/Users/ddahlem/Documents/repos/trusty/red-hat-data-services/llama-stack-provider-trustyai-garak`
**Branch**: `main` | **Commit**: `4501e6ca`
...
| Metric | Value |
|--------|-------|
| **Overall Score** | **65.1/100** 🥈 **Silver** ([Tier Definitions](https://agentready.dev/attributes.html#tier-system)) |
...
4. **.gitignore Completeness** (Tier 2) - +3.0 points potential
...
**Measured**: 28.7% (Threshold: ≥80%)

**Evidence**:
- Typed functions: 45/157
- Coverage: 28.7%
...
- **Repository Snapshot**: 4501e6ca1d9fd0ed934dfe5bbc6b215aa62433b2
- **Assessment Duration**: 0.3s
